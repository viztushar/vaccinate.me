...
class Utility {
  ...
  List<Map<String, Object>> andamanandNicobarIslands = [
  ...
  List<Map<String, Object>> andhraPradesh = [
  ...
  List<Map<String, Object>> arunachalPradesh = [
  ...
  List<Map<String, Object>> chandigarh = [
    {"district_id": 108, "district_name": "Chandigarh"}
  ];
  List<Map<String, Object>> chhattisgarh = [
  ...
  List<Map<String, Object>> haryana = [
  ...
  List<Map<String, Object>> himachalPradesh = [
  ...
  List<Map<String, Object>> jammuandKashmir = [
  ...
  List<Map<String, Object>> jharkhand = [
  ...
  List<Map<String, Object>> karnataka = [
  ...
  List<Map<String, Object>> maharashtra = [
  ...
  List<Map<String, Object>> manipur = [
  ...
  List<Map<String, Object>> meghalaya = [
  ...
  List<Map<String, Object>> mizoram = [
  ...
  List<Map<String, Object>> nagaland = [
  ...
  List<Map<String, Object>> puducherry = [
  ...
  List<Map<String, Object>> rajasthan = [
  ...
  List<Map<String, Object>> tamilNadu = [
  ...
  List<Map<String, Object>> telangana = [
  ...
  List<Map<String, Object>> tripura = [
  ...
  List<Map<String, Object>> uttarPradesh = [
  ...
  List<Map<String, Object>> uttarakhand = [
  ...
  List<Map<String, Object>> westBengal = [
  ...
  String getTimeinString(String newValue) {
    String finalValue;
    if (newValue.toString().compareTo("Every 1 min") == 0) {
      finalValue = '60000';
    } else if (newValue.toString().compareTo("Every 5 min") == 0) {
      finalValue = '300000';
    } else if (newValue.toString().compareTo("Every 10 min") == 0) {
      finalValue = '600000';
    } else if (newValue.toString().compareTo("Every 30 min") == 0) {
      finalValue = '1800000';
    } else if (newValue.toString().compareTo("Every 1 hours") == 0) {
      finalValue = '3600000';
    } else if (newValue.toString().compareTo("Every 2 hours") == 0) {
      finalValue = '7200000';
    } else if (newValue.toString().compareTo("Every 6 hours") == 0) {
      finalValue = '21600000';
    } else if (newValue.toString().compareTo("Every 12 hours") == 0) {
      finalValue = '43200000';
    }
  ...
  String getStringINTime(String newValue) {
    String finalValue;
    if (newValue.toString().compareTo("60000") == 0) {
      finalValue = 'Every 1 min';
    } else if (newValue.toString().compareTo("300000") == 0) {
      finalValue = 'Every 5 min';
    } else if (newValue.toString().compareTo("600000") == 0) {
      finalValue = 'Every 10 min';
    } else if (newValue.toString().compareTo("1800000") == 0) {
      finalValue = 'Every 30 min';
    } else if (newValue.toString().compareTo("3600000") == 0) {
      finalValue = 'Every 1 hours';
    } else if (newValue.toString().compareTo("7200000") == 0) {
      finalValue = 'Every 2 hours';
    } else if (newValue.toString().compareTo("21600000") == 0) {
      finalValue = 'Every 6 hours';
    } else if (newValue.toString().compareTo("43200000") == 0) {
      finalValue = 'Every 12 hours';
    }

    return finalValue;
  }

  List<Map<String, Object>> getDistrict(Map<String, Object> newValue) {
    List<Map<String, Object>> district = [];
    if (newValue['state_id'].toString().compareTo("1") == 0) {
      district.addAll(Utility().andamanandNicobarIslands);
    } else if (newValue['state_id'].toString().compareTo("2") == 0) {
      district.addAll(Utility().andhraPradesh);
    } else if (newValue['state_id'].toString().compareTo("3") == 0) {
      district.addAll(Utility().arunachalPradesh);
    } else if (newValue['state_id'].toString().compareTo("4") == 0) {
      district.addAll(Utility().assam);
    } else if (newValue['state_id'].toString().compareTo("5") == 0) {
      district.addAll(Utility().bihar);
    } else if (newValue['state_id'].toString().compareTo("6") == 0) {
      district.addAll(Utility().chandigarh);
    } else if (newValue['state_id'].toString().compareTo("7") == 0) {
      district.addAll(Utility().chhattisgarh);
    } else if (newValue['state_id'].toString().compareTo("8") == 0) {
      district.addAll(Utility().dadraandNagarHaveli);
    } else if (newValue['state_id'].toString().compareTo("37") == 0) {
      district.addAll(Utility().damanandDiu);
    } else if (newValue['state_id'].toString().compareTo("9") == 0) {
      district.addAll(Utility().delhi);
    } else if (newValue['state_id'].toString().compareTo("10") == 0) {
      district.addAll(Utility().goa);
    } else if (newValue['state_id'].toString().compareTo("11") == 0) {
      district.addAll(Utility().gujarat);
    } else if (newValue['state_id'].toString().compareTo("12") == 0) {
      district.addAll(Utility().haryana);
    } else if (newValue['state_id'].toString().compareTo("13") == 0) {
      district.addAll(Utility().himachalPradesh);
    } else if (newValue['state_id'].toString().compareTo("14") == 0) {
      district.addAll(Utility().jammuandKashmir);
    } else if (newValue['state_id'].toString().compareTo("15") == 0) {
      district.addAll(Utility().jharkhand);
    } else if (newValue['state_id'].toString().compareTo("16") == 0) {
      district.addAll(Utility().karnataka);
    } else if (newValue['state_id'].toString().compareTo("17") == 0) {
      district.addAll(Utility().kerala);
    } else if (newValue['state_id'].toString().compareTo("18") == 0) {
      district.addAll(Utility().ladakh);
    } else if (newValue['state_id'].toString().compareTo("19") == 0) {
      district.addAll(Utility().lakshadweep);
    } else if (newValue['state_id'].toString().compareTo("20") == 0) {
      district.addAll(Utility().madhyaPradesh);
    } else if (newValue['state_id'].toString().compareTo("21") == 0) {
      district.addAll(Utility().maharashtra);
    } else if (newValue['state_id'].toString().compareTo("22") == 0) {
      district.addAll(Utility().manipur);
    } else if (newValue['state_id'].toString().compareTo("23") == 0) {
      district.addAll(Utility().meghalaya);
    } else if (newValue['state_id'].toString().compareTo("24") == 0) {
      district.addAll(Utility().mizoram);
    } else if (newValue['state_id'].toString().compareTo("25") == 0) {
      district.addAll(Utility().nagaland);
    } else if (newValue['state_id'].toString().compareTo("26") == 0) {
      district.addAll(Utility().odisha);
    } else if (newValue['state_id'].toString().compareTo("27") == 0) {
      district.addAll(Utility().puducherry);
    } else if (newValue['state_id'].toString().compareTo("28") == 0) {
      district.addAll(Utility().punjab);
    } else if (newValue['state_id'].toString().compareTo("29") == 0) {
      district.addAll(Utility().rajasthan);
    } else if (newValue['state_id'].toString().compareTo("30") == 0) {
      district.addAll(Utility().sikkim);
    } else if (newValue['state_id'].toString().compareTo("31") == 0) {
      district.addAll(Utility().tamilNadu);
    } else if (newValue['state_id'].toString().compareTo("32") == 0) {
      district.addAll(Utility().telangana);
    } else if (newValue['state_id'].toString().compareTo("33") == 0) {
      district.addAll(Utility().tripura);
    } else if (newValue['state_id'].toString().compareTo("34") == 0) {
      district.addAll(Utility().uttarPradesh);
    } else if (newValue['state_id'].toString().compareTo("35") == 0) {
      district.addAll(Utility().uttarakhand);
    } else if (newValue['state_id'].toString().compareTo("36") == 0) {
      district.addAll(Utility().westBengal);
    }
